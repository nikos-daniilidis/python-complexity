...
from config import RF, BOOTSTRAP, GREEDY, COMPETING_STREAMS
...
if __name__ == '__main__':
    ...
    classifier_kinds = 10 * [RF]  # classifier to use
    train_args = {'n_estimators': [500, 600],
                  'class_weight': None,
                  'subsample': 0.5,
                  'max_depth': [10, 11, 12],
                  'random_state': 13,
                  'scoring': 'neg_log_loss'}
    ve_config = {'kind': BOOTSTRAP, 'replace': True}
